...
/**
* Renders the Main bar which allow the user find files by filtering it using text. It also allows the user get notifications and logout
*/
export default function MainBar(props) {
    ...
    // TODO: Improve it to fit on mobile and tablets properly
    // Render the menu for mobile or tablets
